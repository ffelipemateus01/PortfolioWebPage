...
btSeeMore.addEventListener("click", ()=>{
    const res = confirm("Você será redirecionado para uma nova página, deseja prosseguir?");
    // abre pagina do chatgpt com prompt definido
    if (res) window.open("https://chatgpt.com/?prompt=Frases%20motivacionais%20para%20o%20trabalho");
});
